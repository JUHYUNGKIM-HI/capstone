...
void httpclient(String char_input){
  ...
  String cmd = "GET /process4.php?heat="+url+" HTTP/1.0\r\n\r\n";
...
void loop(){
  ...
  distance4 = ((340 * cycletime) / 10000) / 2;
  
  Serial.print("distance4:");
  Serial.print(distance4);
  Serial.println("cm");
  
  String str_output = String(heat4)+"&distance4="+String(distance4);
  delay(1000);

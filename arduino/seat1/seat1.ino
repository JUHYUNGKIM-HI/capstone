...
void httpclient(String char_input){
  ...
  String cmd = "GET /process1.php?heat="+url+" HTTP/1.0\r\n\r\n";
...
void loop(){
  ...
  distance1 = ((340 * cycletime) / 10000) / 2;
  
  Serial.print("distance1:");
  Serial.print(distance1);
  Serial.println("cm");
  
  String str_output = String(heat1)+"&distance1="+String(distance1);
  delay(1000);

...
void httpclient(String char_input){
  ...
  String cmd = "GET /process.php?heat="+url+" HTTP/1.0\r\n\r\n";
...
void loop(){
  ...
  distance3 = ((340 * cycletime) / 10000) / 2;
  
  Serial.print("distance3:");
  Serial.print(distance3);
  Serial.println("cm");
  
  String str_output = String(heat3)+"&distance3="+String(distance3);
  delay(1000);
